...
class CrowdinApi {
  ...
  addFile(projectName, files, params) {
    let filesInformation = _.mapKeys(files, (filePath, fileName) => `files[${fileName}]`);

    filesInformation = _.mapValues(filesInformation, filePath => fs.createReadStream(filePath));
  ...
  deleteFile(projectName, fileName) {
    return this.postPromise(`project/${projectName}/delete-file`, undefined, { file: fileName });
  }
  ...
  updateTranslations(projectName, files, language, params) {
    const filesInformation = _.fromPairs(files, fileName => [`files[${fileName}]`, fs.createReadStream(fileName)]);
  ...
  createDirectory(projectName, directory) {
    return this.postPromise(`project/${projectName}/add-directory`, undefined, { name: directory });
  }
  ...
  changeDirectory(projectName, directory, params) {
    return this.postPromise(`project/${projectName}/change-directory`, undefined, { name: directory }, params);
  }
  ...
  deleteDirectory(projectName, directory) {
    return this.postPromise(`project/${projectName}/delete-directory`, undefined, { name: directory });
  }
  ...
  uploadGlossary(projectName, fileNameOrStream) {
    ...
    return this.postPromise(`project/${projectName}/upload-glossary`, undefined, { file: fileNameOrStream });
  }
  ...
  uploadTranslationMemory(projectName, fileNameOrStream) {
    ...
    return this.postPromise(`project/${projectName}/upload-tm`, undefined, { file: fileNameOrStream });
  }
